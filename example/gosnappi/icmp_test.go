...
// PORT1=10.109.121.181/1/1 PORT2=10.109.123.254/1/1 OTGSERVER=localhost:50051 go test -v -test.run TestIcmp
...
func TestIcmp(t *testing.T) {
	...
	//icmp.Echo().Checksum().SetCustom(1000)
	//icmp.Echo().Code().SetValue(0)
	//icmp.Echo().Code().SetValues([]uint32{0, 10, 100, 255})
	//icmp.Echo().Code().Increment().SetStart(0).SetStep(1).SetCount(254)
	//icmp.Echo().Code().Decrement().SetStart(255).SetStep(1).SetCount(254)
	icmp.Echo().Type().SetValue(8)
	//icmp.Echo().Type().SetValues([]uint32{0, 8, 9, 17, 18})
	//cmp.Echo().Type().Increment().SetStart(0).SetStep(1).SetCount(10)
	//icmp.Echo().Type().Decrement().SetStart(254).SetStep(1).SetCount(100)
	//icmp.Echo().SequenceNumber().SetValue(65535)
	//icmp.Echo().SequenceNumber().SetValues([]uint32{0, 10, 100, 1000, 20000, 46789, 65535})
	//icmp.Echo().SequenceNumber().Increment().SetStart(0).SetStep(1).SetCount(100)
	//icmp.Echo().SequenceNumber().Decrement().SetStart(1000).SetStep(1).SetCount(100)
	//icmp.Echo().Identifier().SetValue(100)
	//icmp.Echo().Identifier().SetValues([]uint32{0, 10, 100, 3000, 65535})
	//icmp.Echo().Identifier().Increment().SetStart(0).SetStep(1).SetCount(100)
	icmp.Echo().Identifier().Decrement().SetStart(1000).SetStep(1).SetCount(100)
