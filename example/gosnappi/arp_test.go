...
// PORT1=10.109.121.181/1/1 PORT2=10.109.123.254/1/1 OTGSERVER=localhost:50051 go test -v -test.run TestArp
...
func TestArp(t *testing.T) {
	...
	arp.HardwareType().SetValue(0)
	//arp.HardwareType().SetValues([]uint32{0, 1, 10, 1000, 9999, 10000})
	//arp.HardwareType().Decrement().SetStart(1000).SetStep(1).SetCount(100)
	//arp.HardwareType().Increment().SetStart(0).SetStep(1).SetCount(100)
	arp.HardwareLength().SetValue(100)
	//arp.HardwareLength().SetValues([]uint32{0, 2, 5, 6, 10, 100, 255})
	//arp.HardwareLength().Increment().SetStart(6).SetStep(1).SetCount(100)
	//arp.HardwareLength().Decrement().SetStart(255).SetStep(1).SetCount(100)
	arp.ProtocolLength().SetValue(6)
	//arp.ProtocolLength().SetValues([]uint32{0, 4, 6, 10, 100, 255})
	//arp.ProtocolLength().Increment().SetStart(0).SetStep(1).SetCount(100)
	//arp.ProtocolLength().Decrement().SetStart(255).SetStep(1).SetCount(100)
	arp.Operation().SetValue(2)
	//arp.Operation().SetValues([]uint32{0, 10, 100, 1000, 10000, 65535})
	//arp.Operation().Increment().SetStart(0).SetStep(1).SetCount(100)
	//arp.Operation().Decrement().SetStart(100).SetStep(1).SetCount(10)
	arp.ProtocolType().SetValue(8)
	//arp.ProtocolType().SetValues([]uint32{0, 8, 100}) //stc not support
	//arp.ProtocolType().Increment().SetStart(0).SetStep(1).SetCount(10) //stc not support
	//arp.ProtocolType().Decrement().SetStart(100).SetStep(1).SetCount(10) //stc not support
	arp.SenderHardwareAddr().SetValue("00:01:00:01:00:01")
	//arp.SenderHardwareAddr().SetValues([]string{"00:01:00:01:00:01", "00:01:00:01:00:02", "00:01:00:01:00:03"})
	//arp.SenderHardwareAddr().Increment().SetStart("00:01:00:01:00:01").SetStep("00:00:00:00:00:01").SetCount(4)
	//arp.SenderHardwareAddr().Decrement().SetStart("00:01:00:01:00:05").SetStep("00:00:00:00:00:01").SetCount(4)
	arp.TargetHardwareAddr().SetValue("00:02:00:02:00:02")
	//arp.TargetHardwareAddr().SetValues([]string{"00:02:00:02:00:02", "00:02:00:02:00:03", "00:02:00:02:00:04"})
	//arp.TargetHardwareAddr().Increment().SetStart("00:02:00:02:00:02").SetStep("00:00:00:00:00:01").SetCount(10)
	//arp.TargetHardwareAddr().Decrement().SetStart("00:02:00:02:00:0b").SetStep("00:00:00:00:00:01").SetCount(10)
	arp.SenderProtocolAddr().SetValue("1.1.1.1")
	//arp.SenderProtocolAddr().SetValues([]string{"1.1.1.1", "1.1.1.2", "1.1.1.3", "1.1.1.4"})
	//arp.SenderProtocolAddr().Increment().SetStart("1.1.1.1").SetStep("0.0.0.1").SetCount(10)
	//arp.SenderProtocolAddr().Decrement().SetStart("1.1.1.11").SetStep("0.0.0.1").SetCount(10)
	arp.TargetProtocolAddr().SetValue("2.2.2.2")
	//arp.TargetProtocolAddr().SetValues([]string{"2.2.2.2", "2.2.2.3", "2.2.2.4", "2.2.2.5"})
	//arp.TargetProtocolAddr().Increment().SetStart("2.2.2.2").SetStep("0.0.0.1").SetCount(10)
	//arp.TargetProtocolAddr().Decrement().SetStart("2.2.2.20").SetStep("0.0.0.1").SetCount(10)
